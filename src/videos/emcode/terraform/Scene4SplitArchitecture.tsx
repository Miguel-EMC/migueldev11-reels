  ...
  return (
    <EmcodeSceneWrapper categoryTag="DEBATE & COMUNIDAD" gridColor={brand.green}>
      ...
      >
        ...
        >
          ¿Y en tu empresa <span style={{ color: brand.green, textShadow: brand.glowGreen }}>qué usan? 🤔</span>
        </div>
      </div>

      {/* 2. MIDDLE ZONE: Brand Card with Options */}
      <div
        style={{
          width: "100%",
      ...
      >
        <EmcodeLogo size={80} showText={true} tagline="INFRASTRUCTURE AS CODE & CLOUD" />
      ...
      >
        ...
        <div style={{ fontFamily: brand.fontSans, fontSize: 20, color: brand.cream, marginTop: 8, fontWeight: 700 }}>
          Y sígueme para dominar DevOps e Infraestructura Cloud
        </div>
      </div>
    </EmcodeSceneWrapper>
  );
