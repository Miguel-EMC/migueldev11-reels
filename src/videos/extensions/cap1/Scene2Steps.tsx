...
const EXTENSIONS = [
  { number: "01", title: "Error Lens", desc: "Muestra errores directamente en la línea de código 🎯" },
  { number: "02", title: "GitLens", desc: "Historial y autoría de Git en cada línea 🔍" },
  { number: "03", title: "Console Ninja", desc: "Visualiza console.logs en tu editor al instante ⚡" },
  { number: "04", title: "GitHub Copilot", desc: "Autocompletado ultra inteligente con IA 🤖" },
  { number: "05", title: "Prettier", desc: "Formatea tu código automáticamente ✨" },
];

export const Scene2Steps: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Active extension index (0 to 4) based on 150 frames (5s) per extension
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: brand.bg, overflow: "hidden" }}>
      ...
      {/* Floating radial glow behind active card */}
      <div
        style={{
          position: "absolute",
          top: "50%",
