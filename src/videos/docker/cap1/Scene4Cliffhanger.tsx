    ...
    <AbsoluteFill style={{ backgroundColor: dockerTheme.bg }}>
      ...
      <AbsoluteFill style={{
        ...
        <div style={{
          ...
          <div style={{
            fontFamily: dockerTheme.fontSans, fontSize: 55, fontWeight: 900, color: dockerTheme.cream, lineHeight: 1.2
          }}>
            La confusión #1:<br/>
            <span style={{ color: dockerTheme.red, textShadow: dockerTheme.glowRed }}>Imagen ≠ Contenedor</span>
          </div>
        </div>
