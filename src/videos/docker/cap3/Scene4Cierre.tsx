      ...
      <AbsoluteFill style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            Más ligera =<br/>
            <span style={{ color: dockerTheme.green, textShadow: dockerTheme.glowGreen }}>Más rápida + segura.</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          border: `3px solid ${dockerTheme.red}`, borderRadius: 24, padding: "30px 40px",
          textAlign: "center", marginBottom: 90, opacity: subEntrance,
          transform: `scale(${subEntrance})`, boxShadow: `0 20px 40px rgba(0,0,0,0.5), ${dockerTheme.glowRed}22`
        }}>
          <div style={{ fontFamily: dockerTheme.fontMono, fontSize: 24, color: dockerTheme.red, letterSpacing: 4, marginBottom: 8, fontWeight: 900 }}>
            SERIE DOCKER
          </div>
