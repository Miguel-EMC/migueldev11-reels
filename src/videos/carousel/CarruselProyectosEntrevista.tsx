...
const PortadaSlide: React.FC = () => {
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "160px 80px 140px 80px" }}>
      ...
      >
        3 <GlowText fontSize={68} color={brand.green}>PROYECTOS</GlowText> que
        <br />
        SÍ sorprenden en
        <br />
        una entrevista 💼
      ...
      >
        deja de hacer clones de Netflix o Spotify
      </p>
  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "180px 80px 140px 80px" }}>
      ...
      >
        ¿Qué proyecto tienes
        <br />
        <GlowText fontSize={64}>en tu portfolio hoy? 👇</GlowText>
      </h2>
      ...
      >
        {[
          { num: "01", label: "cli automatizado" },
          { num: "02", label: "infra con terraform" },
          { num: "03", label: "fastapi con agentes" },
          { num: "04", label: "testing y mockups" },
          { num: "05", label: "readme impecable" },
          { num: "06", label: "explicar fallos" },
        ].map((item, idx) => (
          <div
            key={idx}
            style={{
...
const CAROUSEL_SLIDES = [
  { type: "portada" },
  {
    ...
    title: "CLI / Script en Producción",
    desc: "Un script o CLI de terminal documentado y publicado en npm/pip. Resuelve un problema real, tiene tests y lo usan personas reales.",
  },
  {
    type: "content",
    num: "02",
    ...
    desc: "Una infraestructura en AWS/GCP creada con Terraform (IaC). Incluye monitorización, CI/CD automatizado con GitHub Actions y costes optimizados.",
  },
  {
    type: "content",
    num: "03",
    tag: "03 · AI & BACKEND",
    title: "Motor RAG con Agentes",
    desc: "Un backend en FastAPI que conecta embeddings y una base vectorial con LangGraph. Hace búsquedas semánticas y corrige sus propias consultas.",
  },
  {
    type: "content",
    num: "04",
    tag: "QUÉ BUSCAN VER",
    title: "No es el código en sí",
    desc: "En las entrevistas no buscan ver el clon nº 500 de Twitter. Buscan ver buenas prácticas, tests, manejo de errores y que resuelvas problemas.",
  },
  {
    type: "content",
    num: "05",
    tag: "DOCUMENTACIÓN",
    title: "Readme Impecable",
    desc: "Tu README debe tener arquitectura, instrucciones claras para levantar el entorno en Docker, decisiones técnicas y un GIF de demo.",
  },
  {
    type: "content",
    num: "06",
    tag: "HONESTIDAD",
    title: "Explica tus errores",
    desc: "Prepárate para explicar qué falló en el camino, qué decisiones de diseño tomaste y cómo las solucionaste. Eso demuestra senioridad.",
  },
  { type: "cta" },
];

export const CarruselProyectosEntrevista: React.FC = () => {
