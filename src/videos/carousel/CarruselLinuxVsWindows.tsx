  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "160px 80px 140px 80px" }}>
      ...
      >
        Por qué programo en
        <br />
        <GlowText fontSize={68} color={brand.green}>LINUX</GlowText> y no en Windows 🐧
      </h1>
  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "180px 80px 140px 80px" }}>
      ...
      >
        ¿Linux, Mac o Windows?
        <br />
        <GlowText fontSize={64}>Defiéndelo en comentarios 👇</GlowText>
      </h2>

      {/* Recap Grid (2 columns for 5 items) */}
      <div
        style={{
          display: "grid",
      ...
      >
        {[
          { num: "01", label: "producción" },
          { num: "02", label: "terminal" },
          { num: "03", label: "control" },
          { num: "04", label: "herramientas" },
...
const CAROUSEL_SLIDES = [
  { type: "portada" },
  {
    ...
    desc: "Casi todos los servidores del mundo corren Linux. Tu app va a vivir ahí: desarrolla donde se ejecuta.",
  },
  {
    type: "content",
    num: "02",
    tag: "2 · TERMINAL",
    title: "El terminal",
    desc: "En Linux el terminal es de primera clase. Todo es más rápido, scripteable y potente.",
  },
  {
    type: "content",
    num: "03",
    tag: "3 · CONTROL",
    title: "Control total",
    desc: "Configuras todo a tu gusto. Nada de cajas negras ni decisiones tomadas por ti.",
  },
  {
    type: "content",
    num: "04",
    ...
    desc: "Docker, Git y casi todo el stack dev corren nativos y mejor. Menos fricción.",
  },
  {
    type: "content",
    num: "05",
    tag: "5 · OPEN SOURCE",
    title: "Gratis y libre",
    desc: "Gratis, sin licencias, y puedes ver y cambiar cómo funciona todo.",
  },
  {
    type: "content",
    num: "06",
    tag: "LO JUSTO",
    title: "Honestidad",
    desc: "¿La curva al inicio? Sí, existe. Pero una vez que trabajas en Linux, no vuelves.",
  },
  { type: "cta" },
];

export const CarruselLinuxVsWindows: React.FC = () => {
