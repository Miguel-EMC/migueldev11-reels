...
const PortadaSlide: React.FC = () => {
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "160px 80px 140px 80px" }}>
      ...
      >
        <GlowText fontSize={68} color={brand.green}>MONOLITO</GlowText>
        <br />
        vs Microservicios:
        <br />
        La verdad 🧱
      ...
      >
        deja de complicar tus sistemas sin necesidad
      </p>
  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "180px 80px 140px 80px" }}>
      ...
      >
        ¿Monolito Modular o
        <br />
        <GlowText fontSize={64}>Microservicios? Defiéndelo 👇</GlowText>
      </h2>
      ...
      >
        {[
          { num: "01", label: "monolito modular" },
          { num: "02", label: "dolor de microservicios" },
          { num: "03", label: "cuándo migrar real" },
          { num: "04", label: "falacia de acople" },
          { num: "05", label: "ordenar la casa" },
          { num: "06", label: "veredicto final" },
        ].map((item, idx) => (
          <div
            key={idx}
            style={{
...
const CAROUSEL_SLIDES = [
  { type: "portada" },
  {
    ...
    desc: "Sencillo de desarrollar, testear y desplegar. Si separas tu código en módulos limpios, resiste millones de usuarios sin complicar la infraestructura de red.",
  },
  {
    type: "content",
    num: "02",
    tag: "MICROSERVICIOS",
    title: "El dolor real",
    desc: "Introducen latencia de red, problemas de consistencia eventual, y un dolor de cabeza inmenso en monitoreo distribuido, logging unificado y DevOps.",
  },
  {
    type: "content",
    num: "03",
    tag: "LA REGLA",
    title: "Cuándo dar el salto",
    desc: "Solo migra cuando tus equipos de desarrollo se pisen código constantemente o cuando componentes específicos necesiten escalados independientes y extremos.",
  },
  {
    type: "content",
    num: "04",
    tag: "ACOPLAMIENTO",
    title: "La gran falacia",
    desc: "Si para subir una nueva característica tienes que desplegar 4 microservicios en simultáneo a producción, tienes un monolito distribuido.",
  },
  {
    type: "content",
    num: "05",
    tag: "REFLEXIÓN",
    title: "Ordena primero la casa",
    desc: "Si tu monolito es un desorden espagueti de código, tus microservicios serán un caos espagueti distribuido y carísimo de pagar.",
  },
  {
    type: "content",
    num: "EL VEREDICTO",
    title: "Comienza monolítico",
    desc: "Comienza monolítico, escala modularmente, y separa en microservicios independientes solo cuando el monolito modular te empiece a doler de verdad.",
  },
  { type: "cta" },
];

export const CarruselMonolitoMicro: React.FC = () => {
