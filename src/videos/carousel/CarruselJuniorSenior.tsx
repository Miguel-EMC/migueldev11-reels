  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "160px 80px 140px 80px" }}>
      ...
      >
        Cómo pasar de
        <br />
        <GlowText fontSize={68} color={brand.green}>JUNIOR a SENIOR</GlowText> 🧠
      </h1>
      ...
      >
        el salto mental que no te enseña ningún curso
      </p>
  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "180px 80px 140px 80px" }}>
      ...
      >
        ...
        <br />
        <GlowText fontSize={64}>diferencia clave? 👇</GlowText>
      </h2>
      ...
      >
        {[
          { num: "01", label: "código vs valor" },
          { num: "02", label: "saber decir no" },
          { num: "03", label: "comunicación" },
          { num: "04", label: "testing" },
          { num: "05", label: "mentorship" },
          { num: "06", label: "humildad" },
        ].map((item, idx) => (
          <div
            key={idx}
            style={{
...
const CAROUSEL_SLIDES = [
  { type: "portada" },
  {
    ...
    num: "01",
    tag: "CÓDIGO VS VALOR",
    title: "El código no es el fin",
    desc: "El junior quiere escribir código complejo para lucirse. El senior quiere solucionar el problema con la menor cantidad de código posible.",
  },
  {
    type: "content",
    num: "02",
    ...
    desc: "El junior acepta cualquier feature y estimación. El senior sabe cuándo decir no para proteger la estabilidad del sistema.",
  },
  {
    type: "content",
    num: "03",
    tag: "SOFT SKILLS",
    title: "Comunicación > Código",
    desc: "El junior habla en términos ultra-técnicos y confunde al cliente. El senior traduce la complejidad técnica a negocio sin fricciones.",
  },
  {
    type: "content",
    num: "04",
    tag: "DEUDA TÉCNICA",
    title: "Testing y Estabilidad",
    desc: "El junior pospone los tests por flojera. El senior sabe que sin tests unitarios e integración, el código de hoy es la pesadilla del lunes.",
  },
  {
    type: "content",
    num: "05",
    tag: "TRABAJO EN EQUIPO",
    title: "Hacer crecer al equipo",
    desc: "El junior busca brillar de forma individual. El senior mentoriza a su equipo y documenta los procesos para que todos crezcan.",
  },
  {
    type: "content",
    num: "06",
    ...
    desc: "El junior finge saberlo todo por miedo al fracaso. El senior dice 'no lo sé, pero lo investigo' con absoluta seguridad.",
  },
  { type: "cta" },
];

export const CarruselJuniorSenior: React.FC = () => {
