  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "160px 80px 140px 80px" }}>
      ...
      >
        ...
        GIT que
        <br />
        <GlowText fontSize={68} color={brand.green}>SALVAN VIDAS</GlowText> 🛡️
      </h1>
      ...
      >
        deja de borrar carpetas y clonar todo de nuevo
      </p>
  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column", padding: "180px 80px 140px 80px" }}>
      ...
      >
        ¿Qué comando de Git
        <br />
        <GlowText fontSize={64}>te ha salvado más veces? 👇</GlowText>
      </h2>
      ...
      >
        {[
          { num: "01", label: "git cherry-pick" },
          { num: "02", label: "git commit --amend" },
          { num: "03", label: "git reset --soft" },
          { num: "04", label: "git stash pop" },
          { num: "05", label: "git reflog (rescate)" },
          { num: "06", label: "alias personalizados" },
        ].map((item, idx) => (
          <div
            key={idx}
            style={{
...
const CAROUSEL_SLIDES = [
  { type: "portada" },
  {
    ...
    desc: "Trae un commit específico de cualquier otra rama a tu rama actual sin mezclar todo el historial sucio ni hacer merges conflictivos.",
  },
  {
    type: "content",
    num: "02",
    ...
    desc: "Modifica tu último commit local de forma instantánea para corregir un typo en el mensaje o añadir archivos que olvidaste antes de empujar.",
  },
  {
    type: "content",
    num: "03",
    ...
    desc: "Deshaz el último commit local manteniendo todos tus archivos modificados exactamente como estaban en staging, listos para volver a editar.",
  },
  {
    type: "content",
    num: "04",
    tag: "4 · STASH",
    title: "git stash pop",
    desc: "Guarda tus archivos modificados temporalmente en el cajón para cambiar de rama limpio, y recupéralos exactamente como estaban cuando quieras.",
  },
  {
    type: "content",
    num: "05",
    tag: "5 · REFLOG",
    title: "git reflog",
    desc: "El historial definitivo que registra cada movimiento de tu HEAD. Incluso si hiciste un reset hard y crees que perdiste todo tu código, aquí lo encuentras.",
  },
  {
    type: "content",
    num: "TRUCO PRO",
    title: "Crea tus propios Alias",
    desc: "Acelera tu flujo creando atajos en tu consola. Convierte 'git status' en 'gs' y 'git commit -m' en 'gcm' editando tu archivo .gitconfig.",
  },
  { type: "cta" },
];

export const CarruselGitSalvavidas: React.FC = () => {
