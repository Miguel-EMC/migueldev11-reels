    ...
    <AbsoluteFill style={{ backgroundColor: conceptsTheme.bg }}>
      ...
      <AbsoluteFill style={{
        ...
        <div style={{
          ...
          border: `4px solid ${conceptsTheme.pink}`, borderRadius: 32, padding: "60px 40px",
          width: "95%", textAlign: "center", opacity: entrance,
          transform: `scale(${entrance})`, boxShadow: conceptsTheme.glowPink
        }}>
          <div style={{
            fontFamily: conceptsTheme.fontSans, fontSize: 85, fontWeight: 900,
            color: conceptsTheme.cream, lineHeight: 1, letterSpacing: "-4px"
          }}>
            RAG <span style={{ color: conceptsTheme.cyan, textShadow: conceptsTheme.glowCyan }}>VS</span><br/>
            FINE-TUNING
          </div>
        </div>
