      ...
      <AbsoluteFill style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            Menos tokens <span style={{ color: conceptsTheme.pink, textShadow: conceptsTheme.glowPink }}>=</span><br/>
            <span style={{ color: conceptsTheme.green, textShadow: conceptsTheme.glowGreen }}>Menos costo.</span>
          </div>
        </div>

        <div style={{
          background: "rgba(236, 72, 153, 0.1)", backdropFilter: "blur(12px)",
          border: `3px solid ${conceptsTheme.pink}`, borderRadius: 24, padding: "30px 40px",
          textAlign: "center", marginBottom: 90, opacity: entrance,
          boxShadow: `0 20px 40px rgba(0,0,0,0.5), ${conceptsTheme.glowPink}33`,
          display: "flex", flexDirection: "column", alignItems: "center"
        }}>
           <ArrowDownCircle size={60} color={conceptsTheme.pink} style={{ marginBottom: 15 }} />
          <div style={{ fontFamily: conceptsTheme.fontMono, fontSize: 24, color: conceptsTheme.pink, letterSpacing: 4, fontWeight: 800 }}>
            AHORRA TIEMPO Y PLATA
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: conceptsTheme.pink, textShadow: conceptsTheme.glowPink
          }}>
            @migueldev11
          </div>
          <div style={{
